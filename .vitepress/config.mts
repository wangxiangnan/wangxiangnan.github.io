...
export default withMermaid({
  ...
  themeConfig: {
    editLink: {
      pattern:
        "https://github.com/wangxiangnan/wangxiangnan.github.io/edit/main/src/:path",
      text: "编辑页面",
    },
      ...
      "/flutter/": [
        {
          ...
          items: [
            ...
            {
              text: "第十三章：状态管理与InheritedWidget原理",
              link: "/flutter/flutter-13",
            },
            {
              text: "专题一：深入理解Flutter主题",
              link: "/flutter/flutter-theme",
            },
          ],
        },
      ],
      ...
      "/ts/": [
        {
          ...
          items: [
            ...
            {
              text: "第二章 环境搭建与第一个 TypeScript 程序",
              link: "/ts/ch02",
            },
      ...
      "/github-actions/": [
        {
          ...
          items: [
            {
              text: "第一章 什么是 GitHub Actions？",
              link: "/github-actions/ch01",
            },
            { text: "第二章 YAML 语法速查", link: "/github-actions/ch02" },
            { text: "第三章 Workflow 核心概念", link: "/github-actions/ch03" },
            {
              text: "第四章 你的第一个 Workflow",
              link: "/github-actions/ch04",
            },
            { text: "第五章 事件触发器深度解析", link: "/github-actions/ch05" },
            {
              text: "第六章 环境变量与 Secrets 管理",
              link: "/github-actions/ch06",
            },
            {
              text: "第七章 Actions Marketplace",
              link: "/github-actions/ch07",
            },
            ...
            {
              text: "第十一章 Reusable Workflows",
              link: "/github-actions/ch11",
            },
            { text: "第十二章 自定义 Action", link: "/github-actions/ch12" },
            {
              text: "第十三章 完整实战——Node.js 项目从测试到部署",
              link: "/github-actions/ch13",
            },
            {
              text: "第十四章 完整实战——Python 项目 CI/CD",
              link: "/github-actions/ch14",
            },
            { text: "第十五章 部署到云平台", link: "/github-actions/ch15" },
            {
              text: "第十六章 Workflow 调试与排错指南",
              link: "/github-actions/ch16",
            },
      ...
      "/redis/": [
        {
          ...
          items: [
            ...
            {
              text: "第二章 安装Redis与Node.js开发环境搭建",
              link: "/redis/ch02",
            },
            ...
            {
              text: "第十三章 RedisGraph与RedisTimeSeries",
              link: "/redis/ch13",
            },
      ...
      "/ffmpeg/": [
        {
          text: "FFmpeg 完全教程",
          items: [
            { text: "第0章 FFmpeg概览", link: "/ffmpeg/ch00" },
            { text: "第一章 FFmpeg 是什么", link: "/ffmpeg/ch01" },
            {
              text: "第二章 安装与环境配置",
              link: "/ffmpeg/ch02",
            },
            { text: "第三章 命令行基础", link: "/ffmpeg/ch03" },
            { text: "第四章 多媒体基础", link: "/ffmpeg/ch04" },
            { text: "第五章 编解码器", link: "/ffmpeg/ch05" },
            ...
            { text: "第十四章 视频滤镜", link: "/ffmpeg/ch14" },
            { text: "第十五章 音频滤镜", link: "/ffmpeg/ch15" },
            { text: "第十六章 叠加与合成", link: "/ffmpeg/ch16" },
            { text: "第十七章 高级视频效果", link: "/ffmpeg/ch17" },
            { text: "第十八章 复杂滤镜链实战", link: "/ffmpeg/ch18" },
            { text: "第十九章 流媒体协议基础", link: "/ffmpeg/ch19" },
            { text: "第二十章 RTMP 推流实战", link: "/ffmpeg/ch20" },
            { text: "第二十一章 直播录制与回放", link: "/ffmpeg/ch21" },
      ...
      "/network-protocol/": [
        {
          ...
          items: [
            ...
            {
              text: "第一章 协议是什么——通信的本质问题",
              link: "/network-protocol/ch01",
            },
            {
              text: "第二章 为什么要分层——OSI 与 TCP/IP 模型",
              link: "/network-protocol/ch02",
            },
            {
              text: "第三章 比特如何上路——物理层与数据链路层",
              link: "/network-protocol/ch03",
            },
            {
              text: "第四章 IP——让数据包穿越互联网",
              link: "/network-protocol/ch04",
            },
            {
              text: "第五章 封装的艺术——数据从应用到网线的旅程",
              link: "/network-protocol/ch05",
            },
            { text: "第六章 网络诊断工具箱", link: "/network-protocol/ch06" },
            {
              text: "第七章 UDP——最小化的传输层",
              link: "/network-protocol/ch07",
            },
            {
              text: "第八章 TCP 基础——建立连接与可靠传输",
              link: "/network-protocol/ch08",
            },
            {
              text: "第九章 TCP 的可靠性机制——序号、确认与重传",
              link: "/network-protocol/ch09",
            },
            {
              text: "第十章 TCP 拥塞控制——网络的自我保护",
              link: "/network-protocol/ch10",
            },
            {
              text: "第十一章 流量控制与 TCP 进阶特性",
              link: "/network-protocol/ch11",
            },
            {
              text: "第十二章 端口与多路复用——传输层的寻址",
              link: "/network-protocol/ch12",
            },
            {
              text: "第十三章 HTTP 基础——Web 的基石",
              link: "/network-protocol/ch13",
            },
            {
              text: "第十四章 HTTP 深入——缓存、内容协商与 Cookie",
              link: "/network-protocol/ch14",
            },
            {
              text: "第十五章 HTTPS 与 TLS——给 HTTP 穿上铠甲",
              link: "/network-protocol/ch15",
            },
            {
              text: "第十六章 DNS——互联网的通讯录",
              link: "/network-protocol/ch16",
            },
            {
              text: "第十七章 WebSocket——全双工实时通信",
              link: "/network-protocol/ch17",
            },
            {
              text: "第十八章 其他应用层协议——SMTP、FTP、SSH",
              link: "/network-protocol/ch18",
            },
            {
              text: "第十九章 HTTP/2——HTTP 的大修",
              link: "/network-protocol/ch19",
            },
            {
              text: "第二十章 QUIC 与 HTTP/3——从 TCP 到 UDP 的跨越",
              link: "/network-protocol/ch20",
            },
            {
              text: "第二十一章 gRPC 与 Protobuf——高效的 RPC 协议",
              link: "/network-protocol/ch21",
            },
            {
              text: "第二十二章 网络安全协议——防火墙、VPN 与零信任",
              link: "/network-protocol/ch22",
            },
            {
              text: "第二十三章 CDN、Anycast 与大规模网络协议",
              link: "/network-protocol/ch23",
            },
            {
              text: "第二十四章 IoT 协议——MQTT、CoAP 与低功耗网络",
              link: "/network-protocol/ch24",
            },
            {
      ...
      "/agent/": [
        {
          ...
          items: [
            ...
            { text: "第三章 Token与注意力", link: "/agent/ch03" },
            { text: "第四章 Prompt Engineering", link: "/agent/ch04" },
            { text: "第五章 推理策略", link: "/agent/ch05" },
            { text: "第六章 Agent架构全景", link: "/agent/ch06" },
            { text: "第七章 环境搭建", link: "/agent/ch07" },
            { text: "第八章 LCEL", link: "/agent/ch08" },
            { text: "第九章 PModel I/O", link: "/agent/ch09" },
            { text: "第十章 Prompt模板", link: "/agent/ch10" },
            { text: "第十一章 Memory", link: "/agent/ch11" },
            { text: "第十二章 Tools", link: "/agent/ch12" },
            { text: "第十三章 ReAct范式", link: "/agent/ch13" },
            { text: "第十四章 Function Calling", link: "/agent/ch14" },
            { text: "第十五章 LangGraph入门", link: "/agent/ch15" },
            { text: "第十六章 LangGraph Agent实战", link: "/agent/ch16" },
            { text: "第十七章 持久化与Checkpointer", link: "/agent/ch17" },
            { text: "第十八章 Human-in-the-Loop", link: "/agent/ch18" },
            { text: "第十九章 数据连接与加载", link: "/agent/ch19" },
            { text: "第二十章 RAG进阶", link: "/agent/ch20" },
            { text: "第二十一章 自定义Tool开发", link: "/agent/ch21" },
            { text: "第二十二章 多Agent系统", link: "/agent/ch22" },
      ...
      "/linux-command/": [
        {
          ...
          items: [
            ...
            {
              text: "第二十二章 文本处理三剑客——grep、sed、awk",
              link: "/linux-command/ch22",
            },
            {
              text: "第二十三章 高级文本处理与正则表达式",
              link: "/linux-command/ch23",
            },
            {
              text: "第二十四章 性能调优与故障排查",
              link: "/linux-command/ch24",
            },
            {
              text: "第二十五章 Docker容器与Linux现代化",
              link: "/linux-command/ch25",
            },
          ],
        },
      ],
      ...
      "/sqlite/": [
        {
          ...
          items: [
            ...
            {
              text: "第三章 SQL 基础（上）—— DDL 表结构设计",
              link: "/sqlite/ch03",
            },
            {
              text: "第四章 SQL 基础（中）—— DML 增删改查",
              link: "/sqlite/ch04",
            },
            {
              text: "第五章 SQL 基础（下）—— JOIN、子查询与聚合",
              link: "/sqlite/ch05",
            },
            ...
            {
              text: "第十章 Flutter 集成（一）——sqflite 上手实战",
              link: "/sqlite/ch10",
            },
            {
              text: "第十一章 Flutter 集成（二）——Drift 类型安全 ORM",
              link: "/sqlite/ch11",
            },
            {
              text: "第十二章 FTS5：让SQLite变身Elasticsearch（迷你版）",
              link: "/sqlite/ch12",
            },
            {
              text: "第十三章 JSON1：让SQLite变身MongoDB（迷你版）",
              link: "/sqlite/ch13",
            },
            {
              text: "第十四章 R-Tree：让SQLite变身PostGIS（迷你版）",
              link: "/sqlite/ch14",
            },
            ...
            {
              text: "第二十二章 实战——Flutter 笔记应用完整项目",
              link: "/sqlite/ch22",
            },
          ],
        },
    ...
    socialLinks: [
      {
        icon: "github",
        link: "https://github.com/wangxiangnan/wangxiangnan.github.io",
      },
    ],
  },
  outDir: "dist",
